# vbwd-fe-admin-plugin-discount

> fe-admin discount/coupon plugin — discount management UI

**Type:** Admin frontend plugin · **Host app:** `vbwd-fe-admin` · **Plugin:** `discount`
...
Frontend plugins use **named exports** (`export const discountPlugin`).
